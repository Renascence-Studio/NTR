...
public class NTRConfig {
    ...
    static {
        ...
        TRANSMISSITE_ITEM_CHANCE = builder.comment("The probability of transmission when attacking").defineInRange("transmission_probability", 0.5D, 0.0D, 1.0D);
        TRANSMISSITE_ITEM_DAMAGE = builder.comment("The damage of transmission when attacking").defineInRange("damage", 5, 0, Integer.MAX_VALUE);
        builder.pop();
